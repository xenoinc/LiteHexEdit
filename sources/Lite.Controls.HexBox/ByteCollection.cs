...
{
  /// <summary>Represents a collection of bytes.</summary>
  public class ByteCollection : CollectionBase
  {
    ...
    /// <summary>Initializes a new instance of ByteCollection class.</summary>
    ...
    /// <summary>Adds a byte into the collection.</summary>
    /// <param name="b">the byte to add</param>
    public void Add(byte b) => List.Add(b);

    /// <summary>Adds a range of bytes to the collection.</summary>
    /// <param name="bs">the bytes to add</param>
    public void AddRange(byte[] bs) => InnerList.AddRange(bs);

    /// <summary>Returns true, if the byte exists in the collection.</summary>
    public bool Contains(byte b) => InnerList.Contains(b);

    /// <summary>Copies the content of the collection into the given array.</summary>
    public void CopyTo(byte[] bs, int index) => InnerList.CopyTo(bs, index);

    /// <summary>Gets all bytes in the array.</summary>
    ...
    /// <summary>Returns the index of the given byte.</summary>
    public int IndexOf(byte b) => InnerList.IndexOf(b);

    /// <summary>Inserts a byte to the collection.</summary>
    /// <param name="index">the index</param>
    /// <param name="b">a byte to insert</param>
    public void Insert(int index, byte b) => InnerList.Insert(index, b);

    /// <summary>Inserts a range of bytes to the collection.</summary>
    ...
    /// <summary>Removes a byte from the collection.</summary>
    /// <param name="b">the byte to remove</param>
    public void Remove(byte b) => List.Remove(b);

    /// <summary>Removes a range of bytes from the collection.</summary>
    ...
    /// <summary>Copies the content of the collection into an array.</summary>
