...
namespace Lite.Windows.Forms
{
  ...
  public class HexBox : Control
  {
    ...
    /// <summary>Contains the border큦 left shift.</summary>
    private int _recBorderLeft = SystemInformation.Border3DSize.Width;

    /// <summary>Contains the border큦 right shift.</summary>
    private int _recBorderRight = SystemInformation.Border3DSize.Width;

    /// <summary>Contains the border큦 top shift.</summary>
    ...
    /// <summary>Gets or sets the hex box큦 border style.</summary>
