...
{
  /// <summary>Implements a fully editable byte provider for file data of any size.</summary>
  /// <remarks>
  ...
  public sealed class DynamicFileByteProvider : IByteProvider, IDisposable
  {
    ...
    /// <summary>Gets a value, if the file is opened in read-only mode.</summary>
